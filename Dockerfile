# DeerFlow Full Stack for Render (Free Plan)
...
RUN cd /app/frontend && SKIP_ENV_VALIDATION=1 NEXT_TELEMETRY_DISABLED=1 NODE_OPTIONS=--max-old-space-size=384 pnpm build
